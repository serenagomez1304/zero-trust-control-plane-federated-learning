...
\begin{table}[h]
\caption{Placeholder: Attack success rates against principal-based baseline vs.\ purpose-and-context model.}
\label{tab:attack-success}
\centering
\begin{tabular}{lccc}
\toprule
Attack class & Baseline ASR & Ours ASR & Bounded exposure \\
\midrule
Rogue substitution & XX\% & XX\% & XX\% \\
Prompt injection & XX\% & XX\% & XX\% \\
Supply-chain compromise & XX\% & XX\% & XX\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\caption{Placeholder: FL aggregation strategy comparison on trust-decision task.}
\label{tab:fl-comparison}
\centering
\begin{tabular}{lcccc}
\toprule
Method & IID acc. & Mild non-IID & Severe non-IID & Comm. rounds \\
\midrule
Centralized (upper bound) & XX.X & --- & --- & --- \\
FedAvg & XX.X & XX.X & XX.X & XXX \\
FedProx & XX.X & XX.X & XX.X & XXX \\
SCAFFOLD & XX.X & XX.X & XX.X & XXX \\
FedNova & XX.X & XX.X & XX.X & XXX \\
\bottomrule
\end{tabular}
\end{table}
